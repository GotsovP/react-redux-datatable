...
var prepareFetchTableParams = function prepareFetchTableParams(tableSettings, limit, offset, sortName, sortOrder, searchValue, columnFilters, selectedCustomer) {
  ...
  if (typeof selectedCustomer !== 'undefined') params.append('selectedCustomer', JSON.stringify(selectedCustomer));
  return params;
};
...
var fetchTableData = exports.fetchTableData = function fetchTableData(tableSettings, limit, offset, sortName, sortOrder, searchValue, columnFilters, apiLocation, axiosInstance, selectedCustomer) {
  return function (dispatch) {
    ...
    var params = prepareFetchTableParams(tableSettings, limit, offset, sortName, sortOrder, searchValue, columnFilters, selectedCustomer);
